...
class ArrayQueue(object):
    ...
    def enqueue(self, newItem):
        ...
        if self.isFull():
            ...
            if self._rear == ArrayQueue.DEFAULT_CAPACITY - 1:  # end of array?
                self._rear = 0
            else:
                self._rear += 1 
            # or  self._rear = (self._rear + 1) % ArrayQueue.DEFAULT_CAPACITY
    ...
    def dequeue(self):
        ...
        if self.isEmpty():
            ...
            if self._front == ArrayQueue.DEFAULT_CAPACITY - 1:   # end of array?
                self._front = 0
            else:
                self._front += 1
            # or  self._front = (self._front + 1) % ArrayQueue.DEFAULT_CAPACITY
